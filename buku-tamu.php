					...
					<div class="col-md-8">
						<div class="post-detail">
							...
							<div class="row post-content">
								<div class="col-sm-12">
									<a class="btn btn-primary" data-toggle="modal" href='#buku-modal'>Tulis Saran & Masukan</a>
									<hr>
									<div class="buku-tamu" id="buku-tamu">
										<?php if ($komen_qry->num_rows == 0) { ?>
											<h4 class="text-muted text-center">Belum Ada Saran & Masukan</h4>
										<?php } else { ?>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Kirim Saran & Masukan</h4>
			</div>
